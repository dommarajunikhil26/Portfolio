        ...
        <header className="relative inset-x-0 top-0 z-50">
            <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    ...
                    <Link to="#projects" smooth={true} duration={500} onClick={() => { notify("Sorry, still under construction") }} className="cursor-pointer text-sm font-semibold leading-6 text-white hover:shadow-glow" >Projects</Link>
                            ...
                            <div className="mt-6 flow-root">
                                <div className="-my-6 divide-y divide-gray-500/10">
                                    <div className="space-y-2 py-6">
                                        ...
                                        <Link to="#projects" smooth={true} duration={500} onClick={() => { setNavOpen(false); notify("Sorry, still under construction"); }} className="cursor-pointer -mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:shadow-glow">Projects</Link>
